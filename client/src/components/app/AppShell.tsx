...
export function AppShell({ children }: AppShellProps) {
  ...
  const isDashboardSettings = isDashboard && tabParam === "settings";
  ...
  return (
    <div className="min-h-screen flex app-surface">
        ...
        <nav className="flex-1 overflow-y-auto p-3 space-y-6">
          ...
          <div className="space-y-0.5">
            ...
            <Link href="/dashboard?tab=settings">
              <a className={navLinkClass(isDashboardSettings)}>
      ...
      >
        <header
          className="sticky top-0 z-30 flex h-14 shrink-0 items-center justify-end border-b border-slate-200 bg-white px-6"
