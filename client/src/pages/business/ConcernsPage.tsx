  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        ...
        className="flex items-center gap-2 text-slate-600 bg-slate-100/80 border border-slate-200 rounded-xl px-4 py-3"
      >
        <Shield className="w-5 h-5 text-slate-500 flex-shrink-0" />
        <span className="text-sm font-medium">Private internal data — for staff only</span>
      </motion.div>

      <div>
        <h2 className="text-2xl font-bold text-slate-900">Concerns inbox</h2>
        <p className="text-slate-500 text-sm mt-0.5">Private feedback from customers</p>
      </div>
